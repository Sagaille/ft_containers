...
/*   Updated: 2021/12/15 13:47:48 by ldavids          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#include "includes/vector/random_access_iterator.hpp"
...
int main()
{
	...
	for( ft::vector<int>::const_iterator it3 = test3.begin() ; it3 != test3.end() ; ++it3 )
		{ std::cout << *it3 << std::endl; }

	std::cout << "rbegin() with reverse_iterator" << std::endl;
	ft::vector<int>::reverse_iterator	it4 = test3.rbegin();
	std::cout << "*it4 == " << *it4 << std::endl;
	std::cout << "rend() with reverse_iterator" << std::endl;
	ft::vector<int>::reverse_iterator	it5 = test3.rend();
	it5--;
	...
	std::cout << std::endl;
	std::cout << "ft::swap(test5, test3) -- NON MEMBER;" << std::endl;
	ft::swap(test5, test3);
	it1 = test3.begin();
	it2 = test3.end();
	while (it1 != it2)
	...
	std::cout << std::endl;
	std::cout << "ft::vector<int>::iterator it3 = it2;" << std::endl;
	ft::vector<int>::iterator it3 = it2;
	std::cout << "*it3 == " << *it3 << std::endl;
	ft::vector<int>::iterator it8(it2);
	...
	ft::vector<int>::reverse_iterator it9 = test3.rbegin();
	ft::vector<int>::iterator it10 = test3.end();
